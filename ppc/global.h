...
typedef struct global_tag
{
	...
	int first_binding_in_file;
	int binding;
	int first_in_location_in_file;
	int in_location;
	int first_out_location_in_file;
	int out_location;

	PLIST pLocations; // PLOCATION_BINDING
	PLIST pBindings; // PLOCATION_BINDING

	PVARTEXT pvtOut; // builds output into this buffer instead of writing output to a file.
	uintptr_t current_shader_info;
