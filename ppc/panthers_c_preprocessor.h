...
INTERFACE_METHOD void ProcessFile( char *file, PVARTEXT pvtOutput, uintptr_t shaderInfo );
...
INTERFACE_METHOD void DefineDefine( char *name,
                                    char *args,
                                    PTEXT ( *cb )( uintptr_t psvShaderInfo,
                                                   PLIST pArgs ) );
