...
static PTEXT BreakAndAddEx( char character, PTEXT outdata, PVARTEXT out, uint32_t *spaces, uint32_t *tabs )
{
	PTEXT word;
...
static PTEXT OutputDanglingCharsEx( PTEXT outdata, PVARTEXT out, uint32_t *spaces, uint32_t *tabs )
